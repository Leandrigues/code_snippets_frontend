  ...
  data() {
    return {
      categories: [
        {
          name: "Algorithms",
          svg: require('../assets/001-structure.svg'),
        },
        {
          name: "Database",
          svg: require('../assets/002-server.svg'),
        },
        // "Data Structure",
        // "Database",
        // "Front-end",
